...
public class AllgemeinerServiceTest {
    ...
    public class PutAlleAllgemeinenDatenTest {
        ...
        void putAlleAllgemeinenDatenMitKorrekterAusgabeWennVorhandeneDatenExistieren() {
            ...
            AllgemeineDaten vorhanden = new AllgemeineDaten();
            vorhanden.setAlter(65);
            vorhanden.setBmi(26.5);
            vorhanden.setGeschlecht("männlich");
            vorhanden.setGewicht(70.0);
            vorhanden.setGröße(190.0);

            when(benutzerRepository.findById(benutzerId)).thenReturn(Optional.of(benutzer));
            when(benutzer.getAllgemein()).thenReturn(vorhanden);
            ...
            verify(vorhandeneDaten).setGeschlecht(daten.getGeschlecht());
